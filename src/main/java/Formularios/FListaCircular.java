 ...
 * @author miria
 */
public class FListaCircular extends javax.swing.JFrame {

    Nodo n;
ListaCircular miLista = new ListaCircular();
    /**
     * Creates new form FListaCircular
     */
    public FListaCircular() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FListaCircular.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
